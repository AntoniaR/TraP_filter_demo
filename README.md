...
Demo_Slides_2024.pdf are the slides used when the author was presenting this demo in 2024.
...
It's recommended to install TraP within a miniconda environment.
TraP can be installed with:  pip install trap
